...
book1 = Book(title=u"Flask Web Development",
             subtitle=u"Python-based Web Application Development Framework",
...
""")
book2 = Book(title=u"STL source code analysis",
             subtitle=u"Pa Ding Jie Niu, you can recover with ease",
             author=u"Hou Jie",
             isbn='9787560926995',
...
book3 = Book(title=u"Principle of Compilation (2nd Edition of the Original Book)",
             subtitle=u"Principle, Technology and Tools",
...
book4 = Book(title=u"In-depth understanding of computer systems",
...
book5 = Book(title=u"C# in a nutshell",
             subtitle=u"The Definitive Guide to C#5.0",
             author=u"Joseph Albahari / Ben Albahari",
             isbn="9787517010845",
             tags_string=u"computer, programming, C#",
...
db.session.add_all([admin, user1, user2, user3, user4, book1, book2, book3,
                    book4, book5, book6] + logs)
db.session.commit()
