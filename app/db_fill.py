...
user1 = User(name=u'akarin', email='akarin@Gmail.com', password='123456', major='Computer Science', headline=u"ordinary student")
user2 = User(name=u'test', email='test@test.com', password='123456')
user3 = User(name=u'Xiao Ming', email='xiaoming@163.com', password='123456')
...
""")
book2 = Book(title=u"STL source code analysis", subtitle=u"Pa Ding Jie Niu, you can recover with ease", author=u"Hou Jie", isbn='9787560926995',
...
book3 = Book(title=u"Principle of Compilation (2nd Edition of the Original Book)", subtitle=u"Principle, Technology and Tools",
...
book4 = Book(title=u"In-depth understanding of computer systems", author="Randal E.Bryant / David O'Hallaron", isbn="9787111321330",
...
book5 = Book(title=u"C# in a nutshell", subtitle=u"The Definitive Guide to C#5.0", author=u"Joseph Albahari / Ben Albahari",
